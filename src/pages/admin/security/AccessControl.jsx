    ...
    return (
        <div className="space-y-6">
            <div className="flex items-center gap-4">
                ...
                <div>
                    <h1 className="text-2xl font-bold text-secondary-900">Access Control</h1>
                    <p className="text-secondary-500">Configure authentication policies</p>
                </div>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                ...
                <div className="bg-white p-6 rounded-xl shadow-sm border border-secondary-200">
                    ...
                    <div className="space-y-4">
                        <div>
                            <label className="block text-sm font-medium text-secondary-700 mb-1">Minimum Length</label>
                            <input
                                type="number"
                        ...
                        <div className="space-y-2">
                            <label className="flex items-center gap-2 cursor-pointer">
                                ...
                                />
                                <span className="text-secondary-700">Require Uppercase</span>
                            </label>
                            <label className="flex items-center gap-2 cursor-pointer">
                                <input
                                    type="checkbox"
                            ...
                            <label className="flex items-center gap-2 cursor-pointer">
                                <input
                                    ...
                                    className="rounded text-primary-600 focus:ring-primary-500"
                                />
                                <span className="text-secondary-700">Require Symbols</span>
                            </label>
                        </div>
                        <div>
                            <label className="block text-sm font-medium text-secondary-700 mb-1">Password Expiry (Days)</label>
                            <input
                                type="number"
                                className="w-full px-3 py-2 border border-secondary-300 rounded-lg"
                ...
                <div className="space-y-6">
                    <div className="bg-white p-6 rounded-xl shadow-sm border border-secondary-200">
                        ...
                        <div className="space-y-4">
                            ...
                            <div>
                                <label className="block text-sm font-medium text-secondary-700 mb-1">Max Concurrent Sessions</label>
                                <input
                                    type="number"
                                    className="w-full px-3 py-2 border border-secondary-300 rounded-lg"
                    ...
                    <div className="bg-white p-6 rounded-xl shadow-sm border border-secondary-200">
                        ...
                        <div className="flex items-center gap-4 p-4 bg-red-50 border border-red-100 rounded-lg mb-4">
                            <AlertTriangle className="text-red-600" />
                            <p className="text-sm text-red-700">Strict lockout policies help prevent brute-force attacks.</p>
                        </div>
                        <div className="grid grid-cols-2 gap-4">
                            <div>
                                <label className="block text-sm font-medium text-secondary-700 mb-1">Max Attempts</label>
                                <input
                                    type="number"
                                    className="w-full px-3 py-2 border border-secondary-300 rounded-lg"
                            ...
                            <div>
                                <label className="block text-sm font-medium text-secondary-700 mb-1">Duration (Min)</label>
                                <input
                                    type="number"
                                    className="w-full px-3 py-2 border border-secondary-300 rounded-lg"
